...
import foodeliver.R;
import foodeliver.entities.Restaurant;
import foodeliver.utility.Transition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!registerRestaurantPasswordText.getText().toString().
                        equals(registerRestaurantConfirmPasswordText.getText().toString())) {
                    Toast.makeText(RestaurantRegisterActivity.this,
                            "Confirmed password is not consistent.", Toast.LENGTH_LONG).show();
                } else {
